...
public class LashingPlanner extends BaseTest {
	...
	public LashingPlanner() throws FileNotFoundException {
		super();
	...
	@Test
	public void VerifyCreateLashingPlanningConeMan() throws Exception {
		...
		LashingDeployment lashingdeployment = PageFactory.initElements(driver, LashingDeployment.class);
		...
		Thread.sleep(3000);
		menuNavigation.navigateToLashingPLanning();
		lashingdeployment.createLasherPlanning();
