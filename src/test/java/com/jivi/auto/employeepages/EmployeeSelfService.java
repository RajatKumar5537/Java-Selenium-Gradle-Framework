...
public class EmployeeSelfService extends BaseTest {
	...
	public void employeeSelfServiceApplyAnnualLeave() throws Exception {
		...
		leaveFrom.clear();
		Thread.sleep(3000);
		webAction.setText(leaveFrom, "14-06-2023");
		Thread.sleep(1000);
		leaveFrom.sendKeys(Keys.TAB);
		leaveTo.clear();
		Thread.sleep(3000);
		webAction.setText(leaveTo, "14-06-2023");
		Thread.sleep(1000);
		leaveTo.sendKeys(Keys.TAB);
		webAction.scrollDown();
		webAction.setText(leaveRemarks, "Testing");
		Thread.sleep(3000);
		webAction.clickUsingJavaScript(applyLeaveNextButton);
		Thread.sleep(1000);
...
public void employeeSelfServiceApplyTimeOff() throws Exception {
	...
	Thread.sleep(500);
	dateTimeOffDate.sendKeys("15-06-2023");
