...
public class LashingDeployment extends BaseTest {
	...
	public LashingDeployment() throws FileNotFoundException {
	...
	@FindBy(xpath = "//button[@id='btnSearchLashingDeployment']")
	WebElement btnSearchLashingPlanning;
	...
	@FindBy(xpath = "(//*[@id='dvContent']//div/button[1])[1]")
	WebElement LashersButtonADD;
	
	@FindBy(xpath = "//a[text()='Cone Man']")
	WebElement ConeManButton;

	@FindBy(xpath = "//a[text()='Tab Reader']")
	WebElement TabReaderButton;
	
	@FindBy(xpath = "//a[text()='Top Man']")
	WebElement TopManButton;
	
	@FindBy(xpath = "//a[text()='Lashers']")
	WebElement LashersButton;
	
	@FindBy(xpath = "//a[text()='Leader']")
	WebElement LeaderButton;
	
	@FindBy(xpath = "//a[text()='Fork Lift']")
	WebElement ForkLiftButton;
	
	@FindBy(xpath = "//button[@title='Move selected']")
	WebElement moveSelectedButton;
	
	@FindBy(xpath = "//button[@title='Move all']")
	WebElement moveAllButton;
	...
	@FindBy(xpath = "//button[@id='btnSaveLashingDeployment']")
	WebElement saveLasherPlanning;
	...
	@FindBy(xpath = "//select[@name='skillName']")
	WebElement skillTypeSelection;
...
//	@FindBy(xpath = "(//*[@id=\"dpDailyPlanningTaskSummary\"]//div[@class='centered_rowheader_inner']//div)["+i+"]")
	...
	public void createLasherPlanning() throws Exception {

		System.out.println("Lashing Deployment");
		Date d = new Date();
		...
		webAction.clickUsingJavaScript(btnSearchLashingPlanning);
		...
		String skillOne = "Cone Man";
		String skillTwo = "CCTV";
		
		List<WebElement> skill = skillTypeSelection
				.findElements(By.xpath("//select[@name='skillName']/option"));
		for (WebElement we : skill) {
			Thread.sleep(500);
			// we.sendKeys(Keys.ARROW_DOWN);
			// if(shiftBandNew.equals(we.getText()))
			if (skillOne.equals(we.getText()))
				we.click();
			// Thread.sleep(500);
		}
		...
		webAction.scrollUp();
		webAction.waitUntilElementIsClickable(LashersButtonADD);
		webAction.clickUsingJavaScript(LashersButtonADD);
		
		System.out.println("Entered into Adding Lashers Deployment");
	
		
		webAction.clickUsingJavaScript(ConeManButton);
		
		
		String craneName = "Crane 1";
		
		removeAllButton.click();
		List<WebElement> craneSelect = craneSelection
				.findElements(By.xpath("//select[@id='bootstrap-duallistbox-nonselected-list_']/option"));
		for (WebElement we : craneSelect) {
			Thread.sleep(500);
			// we.sendKeys(Keys.ARROW_DOWN);
			// if(shiftBandNew.equals(we.getText()))
			if (craneName.equals(we.getText()))
				we.click();
		...
		webAction.clickUsingJavaScript(saveLasherPlanning);
	...
	public void viewDeployment() throws Exception {
		...
		List<WebElement> equipType = skillTypeSelection
