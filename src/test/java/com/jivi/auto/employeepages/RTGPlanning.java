...
public class RTGPlanning extends BaseTest {
	...
	@FindBy(xpath= "//button[@id='btnSaveRTGPlanning']")
	WebElement saveRTGPlanning;
	...
	WebElement dtPlanningRTGFinalBookingReport;
	...
	WebElement btnSearchRTGFinalbookingReport;
...
//	@FindBy(xpath = "(//*[@id=\"dpDailyPlanningTaskSummary\"]//div[@class='centered_rowheader_inner']//div)["+i+"]")
	...
	public void createRTGPlanning() throws Exception {
	...
	//	}
		...
		Thread.sleep(2000);
		webAction.clickUsingJavaScript(btnSearchRTGPlanning);

		Thread.sleep(5000);
		//locationAndSkillSummaryHSSEPlannging();
		//Thread.sleep(50000);

		webAction.waitUntilElementIsClickable(addRTGPlanning);
		webAction.click(addRTGPlanning);
		Thread.sleep(2000);

	

		Thread.sleep(1000);
		webAction.clickUsingJavaScript(saveRTGPlanning);
		Thread.sleep(3000);
...
public void createRTGPlanningwithSignOff() throws Exception {
	...
	//	}
		...
		//Planning SignOff
		webAction.clickUsingJavaScript(buttonPlanningSignOff);
	...
	public void viewDeployment() throws Exception {
		...
		webAction.clickUsingJavaScript(btnSearchRTGFinalbookingReport);
		Thread.sleep(2000);
