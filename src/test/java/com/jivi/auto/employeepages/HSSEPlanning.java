...
public class HSSEPlanning extends BaseTest {
	...
	WebElement dtPlanningHSSEFinalBookingReport;
...
//	@FindBy(xpath = "(//*[@id=\"dpDailyPlanningTaskSummary\"]//div[@class='centered_rowheader_inner']//div)["+i+"]")
	...
	public void locationAndSkillSummaryHSSEPlannging() {
	...
	public void locationAndSkillSummaryHSSEFinalBookingReport() {
		...
		// List<WebElement> skillSummary = driver.findElements(By.xpath(
		// "//*[@id='dpDailyPlanningTaskSummary']//div[@class='centered_rowheader_inner_text']"));
		/*
		 * for (WebElement aa : skillSummary) {
		 * System.out.println("#################################");
		 * System.out.println("Skill Summary:" + aa + "\n");
		 * 
		 * for(int i=2;i<=size;i++) {
		 * System.out.println("#################################");
		 * System.out.println(skillSummaryListsiz.get(i).getText()); }
		 */
	...
	public void createHSSEPlan() throws Exception {
		...
		Thread.sleep(3000);
		webAction.clickUsingJavaScript(addHSSESkillandLocation);
		Thread.sleep(1000);

		dropdown.selectByIndex(locationName, 0);
		LocationNameinHSSE = locationName.getText();
		System.out.println("\n");
		System.out.println("################ Resource Set #######################");
		System.out.println("Location Name in Resource Set:" + LocationNameinHSSE);

		dropdown.selectByIndex(skillCode, 0);
		SkillCodeinHSSE = skillCode.getText();
		System.out.println("Skill Code in Resource Set:" + SkillCodeinHSSE);

		requirement.clear();
		requirement.sendKeys("2");
		System.out.println("Requirement in Resource Set:" + "2");
