...
public class Roaster extends BaseTest {
	MenuNavigation menuNavigation;
	//excelUtilities excelObject;
//	reuableComponents reuse=new reuableComponents();
	...
	//	menuNavigation = new MenuNavigation();
		...
		//reuse = new reuableComponents();
		//Roaster ros=new Roaster();
	}
...
public String createRosterGroupAssignmentRemoveAll() throws Exception {
	...
	//	String rosterGroupNam=createRosterGroupAssignmentAddingAllEmp();
		...
		//dropdown.selectByValue(rosterAvailGroup, createRosterGroupAssignmentAddingAllEmp());
	...
	public void editShiftBand() throws Exception {
		...
		textSearchColumns.sendKeys("Shift");
	...
	//	textSearchColumns.sendKeys(excelObject.getData("EditShiftBand", "Name", "Roaster"));
		textSearchColumns.sendKeys("Shift bbb");
		//menuNavigation.waitforLoadingIcon();
		Thread.sleep(2000);
	...
	public void scheduleCreationRule() throws IOException, InterruptedException {
		...
		Thread.sleep(200);
	//	if (excelObject.getData("Schedule Creation Rule", "ValidToFlag", "Roaster").equals("Yes")) {
			// chkValidTo.click();
		//	reuse.performWebElementClick(chkValidTo);

		//	txtValidTo.sendKeys(excelObject.getData("Schedule Creation Rule", "ValidTo", "Roaster"));
			//reuse.performWebElementTab(txtValidTo);
	//	}
	//	if (excelObject.getData("Schedule Creation Rule", "IsActive?", "Roaster").equals("Yes")) {
			//Thread.sleep(200);
		//	chkIsActive.click();
		//}
	/*	txtPeriodLength.sendKeys(excelObject.getData("Schedule Creation Rule", "Period Length", "Roaster"));
		reuse.performWebElementTab(txtPeriodLength);
		txtShiftlengthMin.sendKeys(excelObject.getData("Schedule Creation Rule", "Shift Length - Min", "Roaster"));
		reuse.performWebElementTab(txtShiftlengthMin);
		txtShiftlengthMax.sendKeys(excelObject.getData("Schedule Creation Rule", "Shift Length - Max", "Roaster"));
		reuse.performWebElementTab(txtShiftlengthMax);
		txtContDaysScheduleOnMin
				.sendKeys(excelObject.getData("Schedule Creation Rule", "Cont. Working Days - Min", "Roaster"));
		reuse.performWebElementTab(txtContDaysScheduleOnMin);
		txtContDaysScheduleOnMax
				.sendKeys(excelObject.getData("Schedule Creation Rule", "Cont. Working Days - Max", "Roaster"));
		reuse.performWebElementTab(txtContDaysScheduleOnMax);
		txtDaysPerPeriodMin.sendKeys(excelObject.getData("Schedule Creation Rule", "Days Per Period - Min", "Roaster"));
		reuse.performWebElementTab(txtDaysPerPeriodMin);
		txtDaysPerPeriodMax.sendKeys(excelObject.getData("Schedule Creation Rule", "Days Per Period - Max", "Roaster"));
		reuse.performWebElementTab(txtDaysPerPeriodMax);
		txtContDaysScheduleOffMin
				.sendKeys(excelObject.getData("Schedule Creation Rule", "Cont. Off Days - Min", "Roaster"));
		reuse.performWebElementTab(txtContDaysScheduleOffMin);
		txtContDaysScheduleOffMax
				.sendKeys(excelObject.getData("Schedule Creation Rule", "Cont. Off Days - Max", "Roaster"));
		reuse.performWebElementTab(txtContDaysScheduleOffMax);
		txtTimePerPeriodMin.sendKeys(excelObject.getData("Schedule Creation Rule", "Time Per Period - Min", "Roaster"));
		reuse.performWebElementTab(txtTimePerPeriodMin);
		txtTimePerPeriodMax.sendKeys(excelObject.getData("Schedule Creation Rule", "Time Per Period - Max", "Roaster"));
		reuse.performWebElementTab(txtTimePerPeriodMax);
		if (excelObject.getData("Schedule Creation Rule", "Include Leave", "Roaster").equals("Yes")) {
			Thread.sleep(100);*/
