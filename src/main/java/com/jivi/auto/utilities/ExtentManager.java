...
public class ExtentManager {
	...
	@FindBy(xpath = "//*[@id='dvLoginScreen']//div[2]/div/div[3]")
	WebElement version;
	
	String build=version.getText();
	String release=build.substring(10);
	...
	public static ExtentReports createInstance(String fileName) {
		...
		/*
		 * htmlReporter.config() .setReportName("Release - " +
		 * GlobalVariables.configData.get("Release") + " Build - " +
