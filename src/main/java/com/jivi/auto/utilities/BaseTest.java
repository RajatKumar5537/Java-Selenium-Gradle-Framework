...
import com.jivi.auto.reports.ExtentITestListenerClassAdapter;
...
import com.jivi.auto.reusablecomponents.KeyHandler;
import com.jivi.auto.reusablecomponents.MouseHandler;
import com.jivi.auto.reusablecomponents.PopupHandler;
import com.jivi.auto.reusablecomponents.ScrollHandler;
import com.jivi.auto.reusablecomponents.Wait;
import com.jivi.auto.webelements.Button;
import com.jivi.auto.webelements.CheckBox;
import com.jivi.auto.webelements.DropDown;
import com.jivi.auto.webelements.Link;
...
public class BaseTest extends GlobalVariables {
	// protected Hashtable<String, String> dataTable;
		...
		@BeforeSuite
		public void beforeSuiteSetup() throws FileNotFoundException, IOException, ParseException, org.json.simple.parser.ParseException {
		...
		public synchronized void beforeMethod(Method method) throws Exception {
			try {
				...
				if (isGridMode) {
					ExtentTest parent = ExtentTestManager.createTest(getClass().getName() + "." + methodName);
					gridParentTest.set(parent);
					...
					test = ExtentTestManager.createTest(getClass().getName() + "." + methodName);
					gridParentTest.set(test);
		...
		protected void launchBrowser() {
			...
			if (System.getenv("URL") != null) {
				goTo(System.getenv("URL").trim());

			} else if (System.getProperty("URL") != null && !System.getProperty("URL").isEmpty()) {
				goTo(System.getProperty("URL").trim());
			}
